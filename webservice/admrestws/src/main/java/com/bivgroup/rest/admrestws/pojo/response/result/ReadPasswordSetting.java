...
public class ReadPasswordSetting {
    ...
    public ReadPasswordSetting() {

    }

    public ReadPasswordSetting(String minLength, String maxLength, String groupsAdditionalAllowed, String groupsCount,
