...
import com.bivgroup.rest.admrestws.validation.handler.NotNullIfDependentNotNullValidator;
...
@Retention(RUNTIME)
@Constraint(validatedBy = {NotNullIfDependentNotNullValidator.class})
@Documented
public @interface NotNullIfDependentNotNull {
