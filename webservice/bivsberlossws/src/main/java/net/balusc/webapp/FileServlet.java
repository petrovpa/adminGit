...
import ru.diasoft.services.inscore.system.servicenamelocator.ServiceNameLocatorException;
...
public class FileServlet extends HttpServlet {
    ...
    public String getModuleName() throws ServletException {
        String result = null;
        try {
            result = WsUtils.getServiceName(ConfigUtils.getProjectProperty("ru.diasoft.services.insurance.ServiceName"));
        } catch (ServiceNameLocatorException e) {
            // TODO Auto-generated catch block
            throw new ServletException("Can't get moduleName property");
        }
        return result;
    }
    // Actions ------------------------------------------------------------------------------------
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content)
        ...
        if (contentType.startsWith("text") || contentType.contains("json")
                 || contentType.contains("javascript") || contentType.contains("image")
