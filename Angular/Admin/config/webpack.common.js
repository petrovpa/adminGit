...
const appRoot = helpers.root('src', 'app');
const coreRoot = helpers.root('..', 'core');
const assetsRoot = helpers.root('..', 'sbslife');
...
module.exports = function (options) {
  ...
  const aliasConfig = Object.assign({}, buildUtils.rxjsAlias(supportES2015), commonAliases);
  ...
  return {
    ...
    resolve: {
       ...
       */
      modules: [root, appRoot, coreRoot, assetsRoot, nodeModules],
    ...
    module: {
      ...
      rules: [
         ...
         */
        {
          ...
          exclude: [helpers.root('src', 'styles'), helpers.root('src', 'app', 'themes')]
        },
