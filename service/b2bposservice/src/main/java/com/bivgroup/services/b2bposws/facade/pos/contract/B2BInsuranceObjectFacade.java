...
/**
 * Фасад для сущности B2BInsuranceObject
 *
 * @author reson
 */
@IdGen(entityName="B2B_INSOBJ",idFieldName="INSOBJID")
@BOName("B2BInsuranceObject")
public class B2BInsuranceObjectFacade extends BaseFacade {
     ...
     * <LI>INSOBJGROUPID - ИД группы объекта</LI>
    ...
    public Map<String,Object> dsB2BInsuranceObjectCreate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BInsuranceObjectInsert", params);
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTROBJID", "HBDATAVERID", "INSOBJID"})
    public Map<String,Object> dsB2BInsuranceObjectInsert(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BInsuranceObjectInsert", params);
        result.put("INSOBJID", params.get("INSOBJID"));
        return result;
    ...
    public Map<String,Object> dsB2BInsuranceObjectUpdate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BInsuranceObjectUpdate", params);
        result.put("INSOBJID", params.get("INSOBJID"));
        return result;
    }
     ...
     */
    @WsMethod(requiredParams = {"INSOBJID"})
    public Map<String,Object> dsB2BInsuranceObjectModify(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BInsuranceObjectUpdate", params);
        result.put("INSOBJID", params.get("INSOBJID"));
        return result;
     ...
     */
    @WsMethod(requiredParams = {"INSOBJID"})
    public void dsB2BInsuranceObjectDelete(Map<String, Object> params) throws Exception {
        this.deleteQuery("dsB2BInsuranceObjectDelete", params);
    }
    ...
    public Map<String,Object> dsB2BInsuranceObjectBrowseListByParam(Map<String, Object> params) throws Exception {
        Map<String,Object> result = this.selectQuery("dsB2BInsuranceObjectBrowseListByParam", "dsB2BInsuranceObjectBrowseListByParamCount", params);
        return result;
    }
