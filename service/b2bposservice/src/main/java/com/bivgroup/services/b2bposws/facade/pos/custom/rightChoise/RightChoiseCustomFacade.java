 ...
 */
package com.bivgroup.services.b2bposws.facade.pos.custom.rightChoise;
 ...
 * @author kkulkov
 */
@BOName("RightChoiseCustom")
public class RightChoiseCustomFacade extends ProductContractCustomFacade {

    private final Logger cLogger = Logger.getLogger(RightChoiseCustomFacade.class);
    ...
    private static final String DEF_PROG_NAME = "RC_BASIC";
...
//        startDateGC.setTime(XMLUtil.convertDate(getDoubleParam(contract.get("STARTDATE"))));
    ...
    public Map<String, Object> dsB2BRightChoiseContractPrepareToSave(Map<String, Object> params) throws Exception {

        cLogger.debug("before dsB2BRightChoiseContractPrepareToSave");
        ...
        if (contract.get("CONTREXTMAP") != null) {
            ...
            //Map<String, Object> banefMap = (Map<String, Object>) contract.get("INSUREDMAP");
            Long insurerId = null;
            if (insurerMap != null) {
            ...
            if (contract.get("BENEFICIARYLIST") != null) {
                ...
                for (Map<String, Object> benmap : benefList) {
                    if ((insuredId != null) && (getLongParam(benmap.get("PARTICIPANTID")).compareTo(insuredId) == 0)) {
            ...
            if ("1".equals(getStringParam(contrExtMap.get("insurerIsInsured")))) {
                //if ((contract.get("MEMBERLIST") == null) || (contract.get("BENEFICIARYLIST") == null)) {
        ...
        cLogger.debug("after dsB2BRightChoiseContractPrepareToSave");
    ...
    public Map<String, Object> dsB2BRightChoiseContractPrepareToSaveFixContr(Map<String, Object> params) throws Exception {

        cLogger.debug("before dsB2BRightChoiseContractPrepareToSaveFixContr");
        ...
        if ((null != params.get("is1CExported")) && ((Boolean) params.get("is1CExported"))) {
            if ((null != params.get("b2bCorrector1C")) && ((Boolean) params.get("b2bCorrector1C"))) {
                ...
                cLogger.debug("after dsB2BRightChoiseContractPrepareToSaveFixContr");
                return contract;
            } else {
