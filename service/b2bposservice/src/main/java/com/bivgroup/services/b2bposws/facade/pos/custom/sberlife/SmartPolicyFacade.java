 ...
 **/
@BOName("SmartPolicy")
public class SmartPolicyFacade extends B2BLifeBaseFacade {
...
//        }
    ...
    public Map<String, Object> dsB2BSmartPolicyCalc(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BSmartPolicyCalc");
        ...
        logger.debug("after dsB2BSmartPolicyCalc");
        return calcRes;
    }
    ...
    public Map<String, Object> dsB2BSmartPolicyContractPrepareToSave(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BSmartPolicyContractPrepareToSave");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        ...
        logger.debug("after dsB2BSmartPolicyContractPrepareToSave");
        return result;
    }
     ...
     */
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BSmartPolicyCustomGetAvailableStrategyForSale(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BSmartPolicyCustomGetAvailableStrategyForSale");
        ...
        logger.debug("after dsB2BSmartPolicyCustomGetAvailableStrategyForSale");
        return result;
    }
    ...
    public Map<String, Object> dsB2BSmartPolicyCalcByContrMap(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BSmartPolicyCalcByContrMap");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        ...
        if (!isDataValid) {
            ...
            logger.debug("after dsB2BSmartPolicyCalcByContrMap");
            return result;
        }
        ...
        Map<String, Object> resMap = this.callService(Constants.B2BPOSWS, "dsB2BSmartPolicyCalc", calcParams, login, password);
        ...
        if (resMap.get("insSum") != null) {
            ...
            setResCalcRiskMapping(contrRiskList, "accidentDeath", resMap, "insSum",
                    null, false);
            setResCalcRiskMapping(contrRiskList, "ILI0_MAIN_PROGRAM", resMap, "insSum",
                    null, false);
            setResCalcRiskMapping(contrRiskList, "ILI0_DEATH_DUE_ACC", resMap, "insSum",
                    null, false);
    ...
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BSmartPolicyContractUnderwritingCheck(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BSmartPolicyContractUnderwritingCheck");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        Map<String, Object> contract;
        if (params.get("CONTRMAP") != null) {
        ...
        logger.debug("after dsB2BSmartPolicyContractUnderwritingCheck");
        return result;
    }
