 ...
 * @author averichevsm
 */
@BOName("InvestNum1Custom")
public class InvestNum1CustomFacade extends B2BLifeBaseFacade {
    ...
    public Map<String, Object> dsB2BInvestNum1Calc(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BInvestNum1Calc");
        ...
        logger.debug("after dsB2BInvestNum1Calc");
        return calcRes;
    }
    ...
    public Map<String, Object> dsB2BInvestNum1CalcByContrMap(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BInvestNum1CalcByContrMap");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        ...
        if (!isDataValid) {
            ...
            logger.debug("after dsB2BInvestNum1CalcByContrMap");
            return result;
        }
        ...
        Map<String, Object> resMap = this.callService(Constants.B2BPOSWS, "dsB2BInvestNum1Calc", calcParams, login, password);
        ...
        if (resMap.get("insSum") != null) {
            ...
            setResCalcRiskMapping(contrRiskList, "accidentDeath", resMap, "insSum",
                    null, false);
            setResCalcRiskMapping(contrRiskList, "RB-ILI0_MAIN_PROGRAM", resMap, "insSum",
                    null, false);
            setResCalcRiskMapping(contrRiskList, "RB-ILI0_DEATH_DUE_ACC", resMap, "insSum",
                    null, false);
    ...
    public Map<String, Object> dsB2BInvestNum1ContractPrepareToSave(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BInvestNum1ContractPrepareToSave");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        ...
        logger.debug("after dsB2BInvestNum1ContractPrepareToSave");
        return result;
    }
    ...
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BInvestNum1ContractUnderwritingCheck(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BInvestNum1ContractUnderwritingCheck");
        String login = params.get(LOGIN).toString();
        String password = params.get(PASSWORD).toString();
        Map<String, Object> contract;
        if (params.get("CONTRMAP") != null) {
        ...
        logger.debug("after dsB2BInvestNum1ContractUnderwritingCheck");
        return result;
    }
    ...
    private String getDeathNSChar(Map<String, Object> contract) {
        ...
        if (riskList == null) {
            ...
            if (riskList.size() == 0) {
                ...
                Map<String, Object> risk = (Map<String, Object>) getLastElementByAtrrValue(riskList, "PRODRISKSYSNAME", "RB-ILI0_DEATH_DUE_ACC");
                if (risk != null) {
                    return "0";//accidentDeath по умолчанию риск СНС всегда включен
                } else {
    ...
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BInvestNum1GetAvailableStrategyForSale(Map<String, Object> params) throws Exception {
        logger.debug("before dsB2BInvestNum1GetAvailableStrategyForSale");
        ...
        logger.debug("after dsB2BInvestNum1GetAvailableStrategyForSale");
        return result;
    }
