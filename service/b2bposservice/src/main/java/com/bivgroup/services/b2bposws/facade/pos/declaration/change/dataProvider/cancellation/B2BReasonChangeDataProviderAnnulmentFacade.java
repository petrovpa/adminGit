...
/**
 * Фасад формирования данных для отчета Аннулирования
 */
public class B2BReasonChangeDataProviderAnnulmentFacade extends B2BReasonChangeDataProviderCancellationCustom {
    private final Logger logger = Logger.getLogger(this.getClass());

    /**
     * Сервис формирования данных для изменения "Анулирован"
     *
    ...
    public Map<String, Object> dsB2BChangeReasonDataProviderAnnulment(Map<String, Object> params) throws Exception {
        logger.debug("dsB2BChangeReasonDataProviderAnnulment end");

        logger.debug("dsB2BChangeReasonDataProviderAnnulment begin");
        ...
        if (program.matches("FIRSTCAPITAL|FAMALYASSETS")) {
            ...
            Instant d2016_09_11 = LocalDate.of(2016, 9, 11).atStartOfDay().toInstant(ZoneOffset.UTC);
            if (documentDate.isAfter(d2016_09_11)) {
            ...
            Instant d2014_10_13 = LocalDate.of(2014, 10, 13).atStartOfDay().toInstant(ZoneOffset.UTC);
            Instant d2014_12_31 = LocalDate.of(2014, 12, 31).atTime(23, 59).toInstant(ZoneOffset.UTC);
            ...
            // Zayavlenie na rastorzhenie_SK-Sberbank* - прекращения по договорам Сетелем, заключенным с 31.08.2016 по н/в
        }
        ...
        reportData.put("BINDOCTYPESYSNAME", "annulment_Pf");
