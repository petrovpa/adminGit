...
/**
 * Фасад для сущности B2BInsuranceObjectGroup
 *
 * @author reson
 */
@IdGen(entityName="B2B_INSOBJGROUP",idFieldName="INSOBJGROUPID")
@BOName("B2BInsuranceObjectGroup")
public class B2BInsuranceObjectGroupFacade extends BaseFacade {
     ...
     * @param params
     * <UL>
     * <LI>CONTRID - ИД договора (устаревшее поле, для удаления)</LI>
    ...
    public Map<String,Object> dsB2BInsuranceObjectGroupCreate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BInsuranceObjectGroupInsert", params);
        result.put("INSOBJGROUPID", params.get("INSOBJGROUPID"));
        return result;
    }
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTRSECTIONID", "HBDATAVERID", "INSOBJGROUPID"})
    public Map<String,Object> dsB2BInsuranceObjectGroupInsert(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BInsuranceObjectGroupInsert", params);
        result.put("INSOBJGROUPID", params.get("INSOBJGROUPID"));
        return result;
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"INSOBJGROUPID"})
    public Map<String,Object> dsB2BInsuranceObjectGroupUpdate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BInsuranceObjectGroupUpdate", params);
        result.put("INSOBJGROUPID", params.get("INSOBJGROUPID"));
        return result;
    }
     ...
     */
    @WsMethod(requiredParams = {"INSOBJGROUPID"})
    public Map<String,Object> dsB2BInsuranceObjectGroupModify(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BInsuranceObjectGroupUpdate", params);
        result.put("INSOBJGROUPID", params.get("INSOBJGROUPID"));
        return result;
     ...
     */
    @WsMethod(requiredParams = {"INSOBJGROUPID"})
    public void dsB2BInsuranceObjectGroupDelete(Map<String, Object> params) throws Exception {
        this.deleteQuery("dsB2BInsuranceObjectGroupDelete", params);
    }
    ...
    public Map<String,Object> dsB2BInsuranceObjectGroupBrowseListByParam(Map<String, Object> params) throws Exception {
        Map<String,Object> result = this.selectQuery("dsB2BInsuranceObjectGroupBrowseListByParam", "dsB2BInsuranceObjectGroupBrowseListByParamCount", params);
        return result;
    }
