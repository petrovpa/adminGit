...
/**
 * Фасад для сущности B2BContractSectionExtension
 *
 * @author reson
 */
@IdGen(entityName="B2B_CONTRSECTIONEXT",idFieldName="CONTRSECTIONEXTID")
@BOName("B2BContractSectionExtension")
public class B2BContractSectionExtensionFacade extends BaseFacade {
     ...
     * @param params
     * <UL>
     * <LI>CONTRSECTIONID - ИД секции договора</LI>
     ...
     * <LI>CONTRSECTIONEXTID - ИД записи</LI>
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTRSECTIONID", "HBDATAVERID"})
    public Map<String,Object> dsB2BContractSectionExtensionCreate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BContractSectionExtensionInsert", params);
        result.put("CONTRSECTIONEXTID", params.get("CONTRSECTIONEXTID"));
        return result;
    }
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTRSECTIONID", "HBDATAVERID", "CONTRSECTIONEXTID"})
    public Map<String,Object> dsB2BContractSectionExtensionInsert(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BContractSectionExtensionInsert", params);
        result.put("CONTRSECTIONEXTID", params.get("CONTRSECTIONEXTID"));
        return result;
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTRSECTIONEXTID"})
    public Map<String,Object> dsB2BContractSectionExtensionUpdate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BContractSectionExtensionUpdate", params);
        result.put("CONTRSECTIONEXTID", params.get("CONTRSECTIONEXTID"));
        return result;
    }
     ...
     */
    @WsMethod(requiredParams = {"CONTRSECTIONEXTID"})
    public Map<String,Object> dsB2BContractSectionExtensionModify(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BContractSectionExtensionUpdate", params);
        result.put("CONTRSECTIONEXTID", params.get("CONTRSECTIONEXTID"));
        return result;
     ...
     */
    @WsMethod(requiredParams = {"CONTRSECTIONEXTID"})
    public void dsB2BContractSectionExtensionDelete(Map<String, Object> params) throws Exception {
        this.deleteQuery("dsB2BContractSectionExtensionDelete", params);
    }
    ...
    public Map<String,Object> dsB2BContractSectionExtensionBrowseListByParam(Map<String, Object> params) throws Exception {
        Map<String,Object> result = this.selectQuery("dsB2BContractSectionExtensionBrowseListByParam", "dsB2BContractSectionExtensionBrowseListByParamCount", params);
        return result;
    }
