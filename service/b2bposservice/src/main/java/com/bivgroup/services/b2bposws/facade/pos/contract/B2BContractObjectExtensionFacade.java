...
/**
 * Фасад для сущности B2BContractObjectExtension
 *
 * @author reson
 */
@IdGen(entityName="B2B_CONTROBJEXT",idFieldName="CONTROBJEXTID")
@BOName("B2BContractObjectExtension")
public class B2BContractObjectExtensionFacade extends BaseFacade {
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTROBJID", "HBDATAVERID"})
    public Map<String,Object> dsB2BContractObjectExtensionCreate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BContractObjectExtensionInsert", params);
        result.put("CONTROBJEXTID", params.get("CONTROBJEXTID"));
        return result;
    }
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTROBJID", "HBDATAVERID", "CONTROBJEXTID"})
    public Map<String,Object> dsB2BContractObjectExtensionInsert(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.insertQuery("dsB2BContractObjectExtensionInsert", params);
        result.put("CONTROBJEXTID", params.get("CONTROBJEXTID"));
        return result;
     ...
     * </UL>
     */
    @WsMethod(requiredParams = {"CONTROBJEXTID"})
    public Map<String,Object> dsB2BContractObjectExtensionUpdate(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BContractObjectExtensionUpdate", params);
        result.put("CONTROBJEXTID", params.get("CONTROBJEXTID"));
        return result;
    }
     ...
     */
    @WsMethod(requiredParams = {"CONTROBJEXTID"})
    public Map<String,Object> dsB2BContractObjectExtensionModify(Map<String, Object> params) throws Exception {
        Map<String,Object> result = new HashMap<String, Object>();
        this.updateQuery("dsB2BContractObjectExtensionUpdate", params);
        result.put("CONTROBJEXTID", params.get("CONTROBJEXTID"));
        return result;
     ...
     */
    @WsMethod(requiredParams = {"CONTROBJEXTID"})
    public void dsB2BContractObjectExtensionDelete(Map<String, Object> params) throws Exception {
        this.deleteQuery("dsB2BContractObjectExtensionDelete", params);
    }
    ...
    public Map<String,Object> dsB2BContractObjectExtensionBrowseListByParam(Map<String, Object> params) throws Exception {
        Map<String,Object> result = this.selectQuery("dsB2BContractObjectExtensionBrowseListByParam", "dsB2BContractObjectExtensionBrowseListByParamCount", params);
        return result;
    }
