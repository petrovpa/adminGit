...
@OrgStructChecker(tableName = "B2B_CONTRORGSTRUCT", orgStructPKFieldName = "CONTRORGSTRUCTID", objTablePKFieldName = "CONTRID",
...
joinStr = " inner join B2B_CONTRORGSTRUCT ORGSTRTABLE on ((T.CONTRID = ORGSTRTABLE.CONTRID) and (ORGSTRTABLE.ISBLOCKED != 1 or ORGSTRTABLE.ISBLOCKED is null))")
/*
todo: вернуть варинат без ORGSTRTABLE.ISBLOCKED <> 1 после доработки аспектов
joinStr = " inner join B2B_CONTRORGSTRUCT ORGSTRTABLE on T.CONTRID = ORGSTRTABLE.CONTRID")
*/
)
@BOName("B2BContractWithRightsCustom")
public class B2BContractWithNewRightsCustomFacade extends B2BBaseFacade {
    ...
    public Map<String, Object> dsB2BContractBrowseListByParamNewRightCustomWhereEx(Map<String, Object> params) throws Exception {
    ...
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BContractBrowseListByParamNewRightCustomCoreWhereEx(Map<String, Object> params) throws Exception {
        ...
        params.put("HIDECHILDCONTR", Boolean.TRUE);
        return this.callService(Constants.B2BPOSWS, "dsB2BContractBrowseListByParamNewRightCustomWhereCoreEx", params, login, password);

    }

    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BContractBrowseListByParamNewRightWhereEx(Map<String, Object> params) throws Exception {
    ...
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsB2BContractBrowseListByParamNewRightCustomWhereCoreEx(Map<String, Object> params) throws Exception {
        String login = params.get(WsConstants.LOGIN).toString();
        String password = params.get(WsConstants.PASSWORD).toString();
