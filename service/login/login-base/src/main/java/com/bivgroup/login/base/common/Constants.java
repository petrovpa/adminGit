package com.bivgroup.login.base.common;
...
public class Constants {
    ...
    public static final String UPPERCASE_LOGIN_PARAM_NAME = "LOGIN";

    /**
     * Максимально число активных сессий для пользователя
     */
    public static final String USER_SESSION_COUNT_PARAMNAME = "ISCONCURRENT";
