...
public class House900CustomFacade extends Mort900BaseFacade {
    ...
    public Map<String, Object> dsB2BHouse900ContractPrepareToSave(Map<String, Object> params) throws Exception {
