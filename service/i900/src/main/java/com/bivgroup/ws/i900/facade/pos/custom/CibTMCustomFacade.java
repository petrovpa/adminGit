 ...
 */
@BOName("CibTMCustom")
public class CibTMCustomFacade extends Mort900BaseFacade {
    ...
    public Map<String, Object> dsB2BCibTMContractPrepareToSave(Map<String, Object> params) throws Exception {

        logger.debug("before dsB2BCibTMContractPrepareToSave");
        ...
        logger.debug("after dsB2BCibTMContractPrepareToSave\n");
