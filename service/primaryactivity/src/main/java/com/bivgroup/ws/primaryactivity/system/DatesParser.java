 ...
 */
package com.bivgroup.ws.primaryactivity.system;
...
public class DatesParser {
        ...
        if (dateValue instanceof String) {
            ...
            if (curVal.contains(" AND ")) {
                ...
                if (dateValue1 == null || dateValue2 == null) {
                    logger.error("method 'parseAnyDate' invoked with incorect date");
     ...
     *
     * @param data обрабатываемая мапа (может содержать списки и вложенные мапы)
