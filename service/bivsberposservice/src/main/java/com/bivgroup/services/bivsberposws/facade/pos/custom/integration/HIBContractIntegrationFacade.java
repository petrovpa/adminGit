 ...
 * @author kkulkov
 */
@BOName("HIBContractIntegration")
public class HIBContractIntegrationFacade extends BaseIntegrationFacade{
    @WsMethod(requiredParams = {})
    public Map<String, Object> dsIntegrationGetHIBContractsData(Map<String, Object> params) throws Exception {
