...
/**
 * LossDamageCategory Generated 14.12.2017 18:39:27 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
...
public class LossDamageCategory  implements java.io.Serializable {
    ...
    public LossDamageCategory(Long id, String externalCode, String hint, String sysname, String name, Long rowStatus) {
       this.id = id;
