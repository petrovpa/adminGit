...
/**
 * ReasonChangeForContract_DecreasePeriod Generated 16.03.2018 18:04:46 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_DecreasePeriod")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_DecreasePeriod extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {
