...
// Generated 16.03.2018 18:04:42 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
...
/**
 * ReasonChangeForContract_BChangeContInfo Generated 16.03.2018 18:04:42 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_BChangeContInfo")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_BChangeContInfo extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {
    ...
    public ReasonChangeForContract_BChangeContInfo() {
    }

	
    public ReasonChangeForContract_BChangeContInfo(Long id) {
        super(id);        
    }
