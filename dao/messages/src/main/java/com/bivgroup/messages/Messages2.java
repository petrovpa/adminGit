...
public class Messages2 extends HierarchyDAO implements ExtendGenericDAO {
    ...
    public void initEntityClasses() {
        ...
        //message
        mapClasses.put("Chat", com.bivgroup.messages.Chat.class);
        mapClasses.put("ChatTopicType", com.bivgroup.messages.ChatTopicType.class);
        mapClasses.put("Message", com.bivgroup.messages.Message.class);
        mapClasses.put("MessageChannel", com.bivgroup.messages.MessageChannel.class);
        mapClasses.put("MessageCorrespondent", com.bivgroup.messages.MessageCorrespondent.class);
        mapClasses.put("MessageRecipient", com.bivgroup.messages.MessageRecipient.class);
        mapClasses.put("Employee", com.bivgroup.messages.Employee.class);
    }
