...
/**
 * ImportSessionEventDepartmentToDepartmentCreated Generated 06.05.2018 15:14:40 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ImportSessionEventDepartmentToDepartmentCreated")   
@Table(name="B2B_IS_CNT_PROCESS_LOG"
)
public class ImportSessionEventDepartmentToDepartmentCreated extends com.bivgroup.imports.ImportSessionContentProcessLogEntry implements java.io.Serializable {
    ...
    public ImportSessionEventDepartmentToDepartmentCreated() {
    }

	
    public ImportSessionEventDepartmentToDepartmentCreated(Long id) {
        super(id);        
    }
    public ImportSessionEventDepartmentToDepartmentCreated(Long id, String note, Long createUserId, Date createDate, Long updateUserId, Date updateDate, ImportSessionContent importSessionCntId_EN, Long importSessionCntId, Long rowStatus, String department2Code, String department2Name, String departmentCode, String departmentName, Long department2Id, Long departmentId) {
