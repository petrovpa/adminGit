...
/**
 * ReasonChangeForContract_ChangeAsset Generated 16.03.2018 18:00:39 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_ChangeAsset")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_ChangeAsset extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {



    public ReasonChangeForContract_ChangeAsset() {
    }

	
    public ReasonChangeForContract_ChangeAsset(Long id) {
        super(id);        
    }
