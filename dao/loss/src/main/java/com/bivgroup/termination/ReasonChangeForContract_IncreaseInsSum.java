...
/**
 * ReasonChangeForContract_IncreaseInsSum Generated 16.03.2018 18:00:37 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_IncreaseInsSum")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_IncreaseInsSum extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {
    ...
    public ReasonChangeForContract_IncreaseInsSum() {
    }

	
    public ReasonChangeForContract_IncreaseInsSum(Long id) {
        super(id);        
    }
