...
// Generated 16.03.2018 18:00:31 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
...
/**
 * ReasonChangeForContract_HChangePassport Generated 16.03.2018 18:00:31 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_HChangePassport")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_HChangePassport extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {
    ...
    public ReasonChangeForContract_HChangePassport() {
    }

	
    public ReasonChangeForContract_HChangePassport(Long id) {
        super(id);        
    }
