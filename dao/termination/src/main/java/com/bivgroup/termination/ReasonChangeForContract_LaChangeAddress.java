...
/**
 * ReasonChangeForContract_LaChangeAddress Generated 16.03.2018 18:02:46 core-dictionary-maven-plugin Maven Mojo 1.01.03-SNAPSHOT 
 */
@Entity
@DiscriminatorValue(value = "ReasonChangeForContract_LaChangeAddress")   
@Table(name="PD_REASONCHANGE"
)
public class ReasonChangeForContract_LaChangeAddress extends com.bivgroup.termination.ReasonChangeForContract implements java.io.Serializable {
